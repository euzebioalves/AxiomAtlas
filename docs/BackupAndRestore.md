...
Também são protegidos, em arquivo criptografado separado: chaves Data Protection de API e Web, `.env`, Compose/Caddy e estado de versão. Dados recriáveis do Caddy não são críticos.
