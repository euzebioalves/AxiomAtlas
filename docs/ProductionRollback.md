...
Informe sempre uma versão existente da release e das imagens imutáveis. O script não remove volumes, não executa migrations e não promete reverter o banco de dados.
